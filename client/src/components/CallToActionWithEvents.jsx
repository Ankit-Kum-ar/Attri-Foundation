...
const CallToActionWithEvents = () => {
  ...
  return (
    <section className="bg-[#F5F5F5] py-10 px-6 md:px-20 font-roboto">
      ...
      <div className="relative bg-cover bg-center rounded-lg overflow-hidden mb-10" style={{ backgroundImage: "url('/cta-background.png')" }}>
        <div className=" bg-opacity-50 p-10 md:p-20 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Make a <span className="text-[#F2C94C]">Difference?</span></h2>
          <p className="text-lg mb-6">Connect with us and be the change in someone's life.</p>
          <div className="flex justify-center gap-4">
            ...
            <button className="bg-white text-black px-6 py-3 rounded-md font-semibold hover:bg-gray-200 cursor-pointer transition">
              Donate
            </button>
          </div>
        </div>
